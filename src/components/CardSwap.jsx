...
const CardSwap = ({
  ...
  return (
    <div
      ref={container}
      className="relative lg:absolute bottom-0 lg:right-0 transform perspective-[900px] overflow-visible scale-[0.7] sm:scale-[0.8] md:scale-[0.9] lg:scale-100 lg:translate-x-[5%] lg:translate-y-[20%] lg:origin-bottom-right mt-16 lg:mt-0"
