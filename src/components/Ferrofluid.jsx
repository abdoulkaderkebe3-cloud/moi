...
const Ferrofluid = ({
  ...
  // `paused` est lu dans une ref et retiré du tableau de dépendances : en le
  // laissant, chaque entrée ou sortie de l'écran détruisait puis recréait le
  // contexte WebGL. La boucle continue, seul le rendu est sauté.
